    ...
    <Container >
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <Nav class="navbar-nav ms-auto" id="main_nav">
                <NavItem>
                    <a class={`nav-link ${activeLink === "home" ? "active" : ""}`} href="#home" on:click={() => (activeLink = "home")}>Anasayfa</a>
                </NavItem>
                <NavItem>
                    <a class={`nav-link ${activeLink === "about" ? "active" : ""}`} href="#about" on:click={() => (activeLink = "about")}>Hakkımızda</a>
                </NavItem>
                <NavItem>
                    <a class={`nav-link ${activeLink === "services" ? "active" : ""}`} href="#services" on:click={() => (activeLink = "services")}>Hizmetlerimiz</a>
                </NavItem>
                <!-- <NavItem>
                    <a class={`nav-link ${activeLink === "client" ? "active" : ""}`} href="#client" on:click={() => (activeLink = "client")}>Müşteriler</a>
                </NavItem> -->
                <NavItem>
                    <a class={`nav-link ${activeLink === "portfolio" ? "active" : ""}`} href="#portfolio" on:click={() => (activeLink = "portfolio")}>Ürünler</a>
                </NavItem>
                <NavItem>
                    <a class={`nav-link ${activeLink === "blog" ? "active" : ""}`} href="#blog" on:click={() => (activeLink = "blog")}>Yeni Ürünler</a>
                </NavItem>
                <NavItem>
                    <a class={`nav-link ${activeLink === "contact" ? "active" : ""}`} href="#contact" on:click={() => (activeLink = "contact")}>İletişim</a>
                </NavItem>
            </Nav>
        </div>
    </Container>
