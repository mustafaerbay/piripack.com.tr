        ...
        <div class="row mt-5">
            <div class="col-lg-4 mt-3">
                <div class="card border-0 rounded p-2">
                    ...
                    <div class="content_blog p-3">
                        <div>
                            <h5 class="fw-bold mb-0"><a href="#contact" class="text-body">There are many variations</a></h5>
                        </div>
                        <div class="mt-3">
                            <p class="h6 text-muted date_blog mb-0">11 March 2018 <a href="#contact" class="text-primary fw-bold">By Kerri</a></p>
                            ...
                            <p class="h6 mb-0"><a href="#contact" class="text-muted fw-bold">Read More...</a></p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 mt-3">
                <div class="card border-0 rounded p-2">
                    ...
                    <div class="content_blog p-3">
                        <div>
                            <h5 class="fw-bold mb-0"><a href="#contact" class="text-body">Contrary to popular belief</a></h5>
                        </div>
                        <div class="mt-3">
                            <p class="h6 text-muted date_blog mb-0">18 March 2018 <a href="#contact" class="text-primary fw-bold">By Kerri</a></p>
                            <p class="mt-3 desc_blog text-muted">Sit sagittis vulputate laoreet sodales tortor nulla lobortis bibendum netus primis fames. Lobortis ultricies.</p>
                            <p class="h6 mb-0"><a href="#contact" class="text-muted fw-bold">Read More...</a></p>
                        </div>
                    </div>
            ...
            <div class="col-lg-4 mt-3">
                <div class="card border-0 rounded p-2">
                    ...
                    <div class="content_blog p-3">
                        <div>
                            <h5 class="fw-bold mb-0"><a href="#contact" class="text-body">Lorem Ipsum is not simply</a></h5>
                        </div>
                        <div class="mt-3">
                            <p class="h6 text-muted date_blog mb-0">22 March 2018 <a href="#contact" class="text-primary fw-bold">By Kerri</a></p>
                            <p class="mt-3 desc_blog text-muted">Sit sagittis vulputate laoreet sodales tortor nulla lobortis bibendum netus primis fames. Lobortis ultricies.</p>
                            <p class="h6 mb-0"><a href="#contact" class="text-muted fw-bold">Read More...</a></p>
                        </div>
                    </div>
